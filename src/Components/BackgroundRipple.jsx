...
export const BackgroundRippleEffect = ({ cellSize = 90, skewAngle = -10 }) => {
  ...
  const colorPairs = [
    ["rgba(90, 150, 220, 0.85)", "rgba(60, 120, 200, 0.85)"],
    ["rgba(130, 100, 220, 0.85)", "rgba(100, 70, 200, 0.85)"],
    ["rgba(80, 200, 180, 0.85)", "rgba(40, 170, 150, 0.85)"],
    ["rgba(220, 120, 160, 0.85)", "rgba(200, 90, 130, 0.85)"]
  ];
